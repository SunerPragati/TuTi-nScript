...
local Window = Fluent:CreateWindow({
    --liên kết máy chủ thành công...
    --ta là hệ thống thay đổi mạnh nhất!
    Title = "Tu Tiên Hệ Thống",
    SubTitle = "Version 2",
    TabWidth = 160,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Tăng Tu Vi", Icon = "home" }),
    Setting = Window:AddTab({ Title = "Chỉnh sửa Tu Vi", Icon = "settings" }),
    Stats = Window:AddTab({ Title = "Chỉ số", Icon = "plus-circle" }),
    Player = Window:AddTab({ Title = "Tu Tiên Giả", Icon = "baby" }),
    Teleport = Window:AddTab({ Title = "Dịch Chuyển", Icon = "palmtree" }),
    Fruit = Window:AddTab({ Title = "Linh Căn", Icon = "cherry" }),
    Raid = Window:AddTab({ Title = "Phó Bản", Icon = "swords" }),
    Race = Window:AddTab({ Title = "Phi Thăng", Icon = "chevrons-right" }),
    Shop = Window:AddTab({ Title = "Shop Hệ Thống", Icon = "shopping-cart" }),
	Misc = Window:AddTab({ Title = "Lặt Vặt", Icon = "list-plus" }),
    Hop = Window:AddTab({ Title = "Xuyên Không", Icon = "wifi" }),
}
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    if game:GetService("Players").LocalPlayer.PlayerGui.Main:FindFirstChild("Phe Tu Luyện") then
        repeat wait()
            if game:GetService("Players").LocalPlayer.PlayerGui:WaitForChild("Main").ChooseTeam.Visible == true then
                if _G.Team == "Tu Ma" then
                    for i, v in pairs(getconnections(game:GetService("Players").LocalPlayer.PlayerGui.Main.ChooseTeam.Container.Pirates.Frame.ViewportFrame.TextButton.Activated)) do                                                                                                
                        v.Function()
                    end
                elseif _G.Team == "Tu Tiên" then
